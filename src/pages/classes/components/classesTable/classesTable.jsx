...
export const ClassTable = ({ turmas, handleDelete, boolean, teacher }) => {
	...
	return (
		<div className="flex mx-4 justify-center rounded-lg shadow-lg border-firstBlue ">
			{!turmas || (!!turmas && turmas.length === 0) ? (
				...
				<di className="w-full rounded-lg">
					{!teacher && (
						<div className="w-full h-[400px] overflow-auto rounded-lg scroll-design">
